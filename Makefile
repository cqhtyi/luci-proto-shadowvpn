...
define Package/luci-proto-shadowvpn/install
	...
	$(INSTALL_DATA) ./files/cbi/proto_shadowvpn.lua $(1)/usr/lib/lua/luci/model/cbi/admin_network
	$(INSTALL_DIR) $(1)/usr/lib/lua/luci/model/network
	$(INSTALL_DATA) ./files/network/proto_shadowvpn.lua $(1)/usr/lib/lua/luci/model/network
endef
